          ...
          IconButton(
            ...
            onPressed: () async {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Buscando HC-05...')),
              );

              final connected = await BluetoothService.connectToPillDispenser();

              if (connected && context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('HC-05 conectado correctamente ✅')),
                );
